...
from purestorage_checkmk_test.flasharray.mock_route import _AuthTokenStorage, _JSONRequest, _JSONResponse, \
...
class Support:
    ...
    remote_assist_opened: typing.Optional[int] = None
    remote_assist_expires: typing.Optional[int] = None
    ...
    def __init__(self):
        self._support.append(
            Support(
                ...
                remote_assist_opened=123123123123,
                remote_assist_expires=123123123132,
...
class _SupportRoute(_AuthenticatedJSONRoute):
    ...
    path = re.compile("^/api/2.21/support")
