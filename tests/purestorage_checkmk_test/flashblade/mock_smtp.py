...
class SMTPServersContainer:
    _smtp_servers: typing.List[SMTPServer]

    def __init__(self):
        self._smtp_servers = []
        self._smtp_servers.append(
            SMTPServer(
                name="default",
    ...
    @property
    def smtp_servers(self) -> typing.List[SMTPServer]:
        return self._smtp_servers


class _SMTPServersRoute(_AuthenticatedJSONRoute):
    _container: SMTPServersContainer
    path = re.compile("^/api/2.9/smtp-servers$")
